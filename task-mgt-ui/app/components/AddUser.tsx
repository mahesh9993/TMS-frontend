            ...
            <div className="flex max-w-md max-auto">
              <div className="py-2">
                <div className="h-14 my-4">
                  ...
                  <input type="text" name="userName" value={newUser.userName} onChange={(e) => handleChange(e)} 
                ...
                <div className="h-14 my-4">
                  ...
                  <input type="text" name="password" value={newUser.password} onChange={(e) => handleChange(e)}
                  className="h-10 w-96 border mt-2 px-2 py-2"></input>
                </div>
                <div className="h-14 my-4">
                  <label className="block text-gray-600 text-sm font-normal">
                  ...
                  <input type="text" name="designation" value={newUser.designation} onChange={(e) => handleChange(e)}
                   className="h-10 w-96 border mt-2 px-2 py-2"></input>
                </div>
